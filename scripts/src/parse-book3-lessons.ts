...
const data = JSON.parse(fs.readFileSync(path.join(ROOT, "scripts/book3-extracted.json"), "utf8")) as Record<string, string[][]>;
...
fs.writeFileSync(path.join(ROOT, "scripts/book3-lessons.json"), JSON.stringify(out, null, 2));
console.log("\nWrote scripts/book3-lessons.json with", out.length, "lessons");
